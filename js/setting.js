...
export class Setting{
  ...
  get elm_active(){
    return this.elm_item_root.querySelector(`:scope > .active`)
  }
  ...
  copy_last(){
    ...
    const next_elm     = this.elm_item_root.querySelector(`:scope > *[data-index="${next_index}"]`)
  ...
  copy_first(){
    ...
    const prev_elm     = this.elm_item_root.querySelector(`:scope > *[data-index="${prev_index}"]`)
  ...
  set_active_center(new_elm){
    const old_active = this.elm_active
  ...
  click_pager(e){console.log("click_pager")
    this.scroll_flg = true
  ...
  get_index_near_elm(index){
    let elm = this.elm_item_root.querySelector(`:scope > *.active ~ [data-index="${index}"]`)
    if(elm){
      return elm
    }
